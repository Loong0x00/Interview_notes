    ...
    <div className="min-h-screen bg-[var(--bg-base)] flex items-center justify-center px-4">
      <div className="w-full max-w-sm">
        ...
        <div className="bg-[var(--bg-surface)] rounded-3xl shadow-[0_10px_40px_rgba(0,0,0,0.04)] dark:shadow-none border border-[var(--border-color)] p-6">
          <h2 className="text-lg font-semibold text-[var(--text-primary)] mb-6 text-center">注册</h2>
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div>
              ...
              <input
                ...
                required
                className="w-full px-3 py-2 border border-[var(--border-color)] rounded-xl text-sm font-mono bg-[var(--bg-surface)] text-[var(--text-primary)] focus:ring-2 focus:ring-[var(--brand)]/30 focus:border-[var(--brand)] outline-none transition-all"
              />
            </div>
          ...
          <p className="mt-4 text-center text-sm text-[var(--text-secondary)]">
            已有账号？
            <button onClick={onGoLogin} className="text-[var(--brand)] hover:opacity-80 font-medium ml-1 transition-opacity">
              登录
            </button>
          </p>
        </div>
